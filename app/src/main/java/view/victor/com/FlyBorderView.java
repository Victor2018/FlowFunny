...
public class FlyBorderView extends View {
    ...
    private void init(Context context) {
        mContext = context;
        mDrawableFlyBorder = mContext.getResources().getDrawable(R.mipmap.img_white_border);
    }
    ...
    private void onDrawUpRect(Canvas canvas) {
        if (null != mDrawableFlyBorder) {
            ...
            mDrawableFlyBorder.setBounds(-padding.left - left,
                -padding.top - top,
