...
public class ReflectItemView extends FrameLayout
{
    ...
    private void init(Context context)
    {
        if (mRefPaint == null)
        {
            ...
            // 倒影渐变.
            mRefPaint.setShader(new LinearGradient(0, 0, 0, REFHEIGHT, new int[] {0x77000000, 0x66AAAAAA, 0x0500000,
                0x00000000}, new float[] {0.0f, 0.1f, 0.9f, 1.0f}, Shader.TileMode.CLAMP));
