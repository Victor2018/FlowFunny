...
public class RippleView extends Button {
    ...
    public RippleView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRippleViewColor = a.getColor(R.styleable.RippleView_rippleViewColor,
                mRippleViewColor);
    ...
    public void init() {
        ...
        mPaint.setAlpha(100);
        setRippleColor(Color.GREEN, 0.2f);

    }

    public void setRippleColor(int rippleViewColor, float alphaFactor) {
        mRippleViewColor = rippleViewColor;
    ...
    public void setRadius(final float radius) {
        ...
        if (mRadius > 0) {
            mRadialGradient = new RadialGradient(mDownX, mDownY, mRadius,
                    adjustAlpha(mRippleViewColor, mAlphaFactor), mRippleViewColor,
